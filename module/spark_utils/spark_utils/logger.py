...
class Logger:
    ...
    def log_scalar(self, scalar, name):
        self._summ_writer.add_scalar('{}'.format(name), scalar, self.counter)
    ...
    def log_graph(self, array, name, step, phase):
        """figure: matplotlib.pyplot figure handle"""
        # need to implement this after
        # im = plot_graph(array)
        # self._summ_writer.add_image('{}_{}'.format(name, phase), im, step)
        raise NotImplementedError
    def log_text(self, tag, text_string, global_step=None, walltime=None):
        self._summ_writer.add_text(tag, text_string, global_step=self.counter)
