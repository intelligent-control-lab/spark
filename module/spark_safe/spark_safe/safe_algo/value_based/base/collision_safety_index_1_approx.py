...
class FirstOrderCollisionSafetyIndexApprox(BasicCollisionSafetyIndex):
    ...
    def __init__(self,
        ...
        assert "Dynamic1" in self.robot_cfg.__class__.__name__, "FirstOrderCollisionSafetyIndexApprox is only supported for robot configuration with Dynamic1 (Velocity Control)"
