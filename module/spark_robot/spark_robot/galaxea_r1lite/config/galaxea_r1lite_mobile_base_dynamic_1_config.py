...
from .isaac_articulation import ISAAC_CAPABILITY, MOBILE_BASE_ISAAC_ARTICULATION
from .simulator_dynamics import R1_LITE_SIMULATOR_DYNAMICS


class GalaxeaR1LiteMobileBaseDynamic1Config(RobotConfig):
    agent_class_names = {
        "mujoco": "GalaxeaR1LiteMobileBaseAgent",
        "isaac": "GalaxeaR1LiteMobileBaseIsaacAgent",
    }
    ...
    kinematics_class_name = "GalaxeaR1LiteMobileBaseKinematics"
    mujoco_model_path = "galaxea_r1lite/r1lite_mobile_base.xml"
    ...
    class MujocoDoFs(IntEnum):
        ...
        # === Right Arm (6 Joints) ===
        # The two physical left-gripper actuators occupy entries 12-13.
        RightJoint1 = 14
        RightJoint2 = 15
        RightJoint3 = 16
        RightJoint4 = 17
