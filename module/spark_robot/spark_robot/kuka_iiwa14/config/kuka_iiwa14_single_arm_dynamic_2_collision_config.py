...
from .arm_collision_geometry import self_collision_ignored_pairs, single_arm_collision_mappings
from .isaac_articulation import KUKA_SINGLE_ARM_GRIPPERS


class KukaIIWA14SingleArmDynamic2CollisionConfig(RobotConfig):
    conformance_position_kp = 12.0
    conformance_velocity_kd = 6.0
