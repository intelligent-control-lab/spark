# AUTO-GENERATED FILE
# Base config: KinovaGen3SingleArmDynamic1Config
# Collision JSON: module/spark_robot/spark_robot/kinova_gen3/config/kinova_gen3_single_arm_collision_spheres.json
...
from .arm_collision_geometry import single_arm_collision_mappings
from .isaac_articulation import KINOVA_SINGLE_ARM_GRIPPERS


class KinovaGen3SingleArmDynamic1CollisionConfig(RobotConfig):
    simulator_dynamics = SimulatorDynamicsSpec(physics_dt=0.005, control_decimation=4)
    agent_class_names = {
        "mujoco": "KinovaGen3SingleArmAgent",
        "isaac": "KinovaGen3SingleArmIsaacAgent",
    }
    isaac_articulation = IsaacArticulationSpec(
        ...
        grippers=KINOVA_SINGLE_ARM_GRIPPERS,
    )
    backend_capability_overrides = {
        "isaac": BackendCapability(
            ...
            notes="CUDA batched hold/tracking validated Gen3 articulation.",
        )
    }
    ...
    kinematics_class_name = "KinovaGen3SingleArmKinematics"
    mujoco_model_path = "kinova_gen3/gen3_2f85_single.xml"
