...
class R1LiteFlatKinematics(RobotKinematics):
    ...
    def _init_fixed_base_kinematics(self):
        ...
        self.rotational_error = casadi.Function(
            ...
            [
                casadi.vertcat(
                    ...
                    cpin.log3(self.cdata.oMf[self.platform_id].rotation @ self.cTf_p[:3,:3].T)
                )
            ],
        )
        ...
        self.opti.minimize(50 * self.translational_cost + 1*self.rotation_cost + 0.02 * self.regularization_cost + 0.01 * self.smooth_cost)
