...
from spark_robot.unitree_g1.config.isaac_articulation import DUAL_ARM_ISAAC_ARTICULATION
...
class UnitreeG1DualArmDynamic1Config(RobotConfig):
    simulator_dynamics = UNITREE_G1_SIMULATOR_DYNAMICS
    isaac_articulation = DUAL_ARM_ISAAC_ARTICULATION
    agent_class_names = {
        "mujoco": "UnitreeG1DualArmMujocoAgent",
        "isaac": "UnitreeG1DualArmIsaacAgent",
        "real": "UnitreeG1RealAgent",
    }
    backend_capability_overrides = {
        "isaac": unitree_g1_isaac_capability("UnitreeG1DualArmIsaacAgent")
    }
    ...
    kinematics_class_name = "UnitreeG1DualArmKinematics"
    mujoco_model_path = "unitree_g1/mjcf/g1_29dof_dual_arm.xml"
    kinematics_model_path = "unitree_g1/mjcf/g1_29dof_fixed_base.xml"
    joint_to_lock = ["waist_yaw_joint", "waist_roll_joint", "waist_pitch_joint"]
    ...
    # PhysX needs a stronger servo than MuJoCo to reproduce this reduced
    # mechanism's joint-tracking response. These scales are deliberately
    # configuration-specific: whole-body and mobile-base variants can tune
    # their own actuator profiles without inheriting dual-arm assumptions.
    IsaacSimStiffnessScale = 4.0
    IsaacSimDampingScale = 1.0
