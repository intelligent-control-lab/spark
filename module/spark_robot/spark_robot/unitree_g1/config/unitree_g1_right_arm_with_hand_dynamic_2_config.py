...
from spark_robot.unitree_g1.config.unitree_g1_right_arm_dynamic_2_config import (
...
class UnitreeG1RightArmWithHandDynamic2Config(UnitreeG1RightArmDynamic2Config):
    kinematics_class_name = UnitreeG1RightArmDynamic2Config.kinematics_class_name
    kinematics_model_path = UnitreeG1RightArmDynamic2Config.mujoco_model_path
    ...
    MujocoDoF_to_DoF, DoF_to_MujocoDoF = _copy_dof_maps(UnitreeG1RightArmDynamic2Config, MujocoDoFs)
    DoF_to_MujocoVel = DoF_to_MujocoDoF
    MujocoMotor_to_Control = _copy_motor_control_map(UnitreeG1RightArmDynamic2Config, MujocoMotors)
    MujocoMotorKps, MujocoMotorKds = _copy_motor_gains(
        UnitreeG1RightArmDynamic2Config, MujocoMotors
    )
