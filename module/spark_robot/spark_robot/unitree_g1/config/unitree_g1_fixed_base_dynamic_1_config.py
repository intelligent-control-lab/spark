...
from spark_robot.unitree_g1.config.isaac_articulation import FIXED_BASE_ISAAC_ARTICULATION
...
class UnitreeG1FixedBaseDynamic1Config(RobotConfig):
    simulator_dynamics = UNITREE_G1_SIMULATOR_DYNAMICS
    isaac_articulation = FIXED_BASE_ISAAC_ARTICULATION
    agent_class_names = {
        "mujoco": "UnitreeG1FixedBaseMujocoAgent",
        "isaac": "UnitreeG1FixedBaseIsaacAgent",
        "real": "UnitreeG1RealAgent",
    }
    backend_capability_overrides = {
        "isaac": unitree_g1_isaac_capability("UnitreeG1FixedBaseIsaacAgent")
    }
    ...
    kinematics_class_name = "UnitreeG1FixedBaseKinematics"
    mujoco_model_path = "unitree_g1/mjcf/g1_29dof_fixed_base.xml"
    joint_to_lock = []
