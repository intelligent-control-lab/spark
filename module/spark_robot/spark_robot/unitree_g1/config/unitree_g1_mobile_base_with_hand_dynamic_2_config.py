...
from spark_robot.unitree_g1.config.unitree_g1_mobile_base_dynamic_2_config import (
...
class UnitreeG1MobileBaseWithHandDynamic2Config(UnitreeG1MobileBaseDynamic2Config):
    kinematics_class_name = UnitreeG1MobileBaseDynamic2Config.kinematics_class_name
