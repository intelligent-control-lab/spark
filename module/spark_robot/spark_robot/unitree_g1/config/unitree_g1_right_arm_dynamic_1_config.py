...
from spark_robot.unitree_g1.config.isaac_articulation import RIGHT_ARM_ISAAC_ARTICULATION
...
class UnitreeG1RightArmDynamic1Config(RobotConfig):
    simulator_dynamics = UNITREE_G1_SIMULATOR_DYNAMICS
    isaac_articulation = RIGHT_ARM_ISAAC_ARTICULATION
    agent_class_names = {
        "mujoco": "UnitreeG1RightArmMujocoAgent",
        "isaac": "UnitreeG1RightArmIsaacAgent",
        "real": "UnitreeG1RealAgent",
    }
    backend_capability_overrides = {
        "isaac": unitree_g1_isaac_capability("UnitreeG1RightArmIsaacAgent")
    }
    ...
    kinematics_class_name = "UnitreeG1RightArmKinematics"
    mujoco_model_path = "unitree_g1/mjcf/g1_29dof_right_arm.xml"
    joint_to_lock = [
        "waist_yaw_joint",
        "waist_roll_joint",
        "waist_pitch_joint",
