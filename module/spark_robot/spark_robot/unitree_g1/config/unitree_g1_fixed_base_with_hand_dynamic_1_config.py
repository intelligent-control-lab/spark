...
class UnitreeG1FixedBaseWithHandDynamic1Config(UnitreeG1FixedBaseDynamic1Config):
    kinematics_class_name = UnitreeG1FixedBaseDynamic1Config.kinematics_class_name
    kinematics_model_path = UnitreeG1FixedBaseDynamic1Config.mujoco_model_path
    ...
    MujocoDoF_to_DoF, DoF_to_MujocoDoF = _copy_dof_maps(
        UnitreeG1FixedBaseDynamic1Config, MujocoDoFs
    )
    DoF_to_MujocoVel = DoF_to_MujocoDoF
    MujocoMotor_to_Control = _copy_motor_control_map(UnitreeG1FixedBaseDynamic1Config, MujocoMotors)
    MujocoMotorKps, MujocoMotorKds = _copy_motor_gains(
        UnitreeG1FixedBaseDynamic1Config, MujocoMotors
    )
