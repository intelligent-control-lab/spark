...
class G1SportModeDynamic2Config(RobotConfig):
    ...
    ControlLimit = {
        ...
        Control.aLinearX           : 30.0,
        Control.aLinearY           : 30.0,
        Control.aRotYaw            : 30.0
    }
    ...
    def dynamics_f(self, state):
        ...
        vLinearX_local = vLinearX_global * np.cos(RotYaw_global) + vLinearY_global * np.sin(RotYaw_global)
        vLinearY_local = -vLinearX_global * np.sin(RotYaw_global) + vLinearY_global * np.cos(RotYaw_global)
        f_x[self.num_dof + self.DoFs.LinearX] = -vLinearX_local * vRotYaw_global * np.sin(RotYaw_global) - vLinearY_local * vRotYaw_global * np.cos(RotYaw_global)
        f_x[self.num_dof + self.DoFs.LinearY] = vLinearX_local * vRotYaw_global * np.cos(RotYaw_global) - vLinearY_local * vRotYaw_global * np.sin(RotYaw_global)
    ...
    MujocoMotorKps = {
        ...
        MujocoMotors.WaistYaw   : 300.0,
        MujocoMotors.WaistRoll  : 300.0,
        MujocoMotors.WaistPitch : 300.0,
    ...
    MujocoMotorKds = {
        ...
        MujocoMotors.WaistYaw   : 5.0,
        MujocoMotors.WaistRoll  : 5.0,
        MujocoMotors.WaistPitch : 5.0,
