# AUTO-GENERATED FILE
# Base config: FanucLRMate200iDSingleArmDynamic1Config
# Collision JSON: module/spark_robot/spark_robot/fanuc_lrmate200id/config/fanuc_lrmate200id_single_arm_collision_spheres.json
...
from .arm_collision_geometry import single_arm_collision_mappings, self_collision_ignored_pairs
from .isaac_articulation import (
    FANUC_SINGLE_ARM_GRIPPER_GAIN_OVERRIDES,
    FANUC_SINGLE_ARM_GRIPPERS,
)


class FanucLRMate200iDSingleArmDynamic2CollisionConfig(RobotConfig):
    simulator_dynamics = SimulatorDynamicsSpec(physics_dt=0.005, control_decimation=4)
    agent_class_names = {
        "mujoco": "FanucLRMate200iDSingleArmAgent",
        "isaac": "FanucLRMate200iDSingleArmIsaacAgent",
    }
    isaac_articulation = IsaacArticulationSpec(
        ...
        grippers=FANUC_SINGLE_ARM_GRIPPERS,
        stiffness=4000.0,
        damping=250.0,
        joint_gain_overrides=FANUC_SINGLE_ARM_GRIPPER_GAIN_OVERRIDES,
    )
    backend_capability_overrides = {
        "isaac": BackendCapability(
            ...
            notes="CUDA batched hold/tracking validated ROS-Industrial 7L articulation.",
        )
    }
    ...
    kinematics_class_name = "FanucLRMate200iDSingleArmKinematics"
    mujoco_model_path = "fanuc_lrmate200id/lrmate200id_single.xml"
    ...
    MujocoMotor_to_Control = {
        MujocoMotors.joint_1: Control.ajoint_1,
        MujocoMotors.joint_2: Control.ajoint_2,
        MujocoMotors.joint_3: Control.ajoint_3,
        MujocoMotors.joint_4: Control.ajoint_4,
        MujocoMotors.joint_5: Control.ajoint_5,
        MujocoMotors.joint_6: Control.ajoint_6,
    }

    # Mapping from real motors to Control
    RealMotor_to_Control = {
        RealMotors.joint_1: Control.ajoint_1,
        RealMotors.joint_2: Control.ajoint_2,
        RealMotors.joint_3: Control.ajoint_3,
        RealMotors.joint_4: Control.ajoint_4,
        RealMotors.joint_5: Control.ajoint_5,
        RealMotors.joint_6: Control.ajoint_6,
    }
    ...
    CollisionVolBodyNames, CollisionVolLocalOffsets = single_arm_collision_mappings(Frames)
