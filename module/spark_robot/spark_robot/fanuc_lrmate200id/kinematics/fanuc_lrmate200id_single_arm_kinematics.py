...
class FanucLRMate200iDSingleArmKinematics(RobotKinematics):
    def __init__(self, robot_cfg: RobotConfig, **kwargs) -> None:
        super().__init__(robot_cfg)
        self.robot_cfg = robot_cfg
        self.mixed_jointsToLockIDs = self.robot_cfg.joint_to_lock
        self.kinematics_model_path = "fanuc_lrmate200id/lrmate200id_single.xml"
    ...
    def add_extra_frames(self, model):
        model.addFrame(
            pin.Frame(
                ...
                pin.SE3(np.array([[0, 0, -1], [0, 1, 0], [1, 0, 0]]), np.array([0.2, 0, 0]).T),
...
if __name__ == "__main__":
    arm_ik = FanucLRMate200iDSingleArmKinematics()
