...
from spark_pipeline import G1BenchmarkPipelineConfig
import time
import matplotlib.pyplot as plt
import subprocess

class G1BenchmarkPipeline(BasePipeline[G1BenchmarkPipelineConfig]):

    def __init__(self, cfg: G1BenchmarkPipelineConfig):
    ...
    def process_and_save_data(self):
        ...
        if self.goal_left_frame_world is not None and self.goal_right_frame_world is not None:
