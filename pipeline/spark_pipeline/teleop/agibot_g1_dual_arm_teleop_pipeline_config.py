...
class AgiBotG1DualArmTeleopPipelineConfig(TeleopPipelineConfig):
    """AgiBot G1 dual-arm teleoperation config."""

    class robot(TeleopPipelineConfig.robot):
        class cfg(TeleopPipelineConfig.robot.cfg):
            class_name = "AgiBotG1DualArmDynamic1Config"
    ...
    class env(TeleopPipelineConfig.env):
        ...
        class agent(TeleopPipelineConfig.env.agent):
            class_name = "AgiBotG1DualArmAgent"
