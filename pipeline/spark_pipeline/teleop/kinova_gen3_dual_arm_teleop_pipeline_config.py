...
class KinovaGen3DualArmTeleopPipelineConfig(TeleopPipelineConfig):
    """Gen3 (2F dual-arm) teleoperation config"""
    ...
    class env(TeleopPipelineConfig.env):
        class task(TeleopPipelineConfig.env.task):
            ...
            goal_left_init = [0.4, 0.3, 0.5]
            goal_right_init = [0.4, -0.3, 0.5]
            ros_params = dict(
