...
class GalaxeaR1LiteDualArmTeleopPipelineConfig(TeleopPipelineConfig):
    """Galaxea R1 Lite dual-arm teleoperation config."""

    class robot(TeleopPipelineConfig.robot):
        class cfg(TeleopPipelineConfig.robot.cfg):
            class_name = "GalaxeaR1LiteDualArmDynamic1Config"
    ...
    class env(TeleopPipelineConfig.env):
        ...
        class agent(TeleopPipelineConfig.env.agent):
            class_name = "GalaxeaR1LiteDualArmAgent"
