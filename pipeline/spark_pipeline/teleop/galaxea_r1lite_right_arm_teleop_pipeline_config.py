...
class GalaxeaR1LiteRightArmTeleopPipelineConfig(TeleopPipelineConfig):
    """Galaxea R1 Lite right-arm teleoperation config."""

    class robot(TeleopPipelineConfig.robot):
        class cfg(TeleopPipelineConfig.robot.cfg):
            class_name = "GalaxeaR1LiteRightArmDynamic1Config"
    ...
    class env(TeleopPipelineConfig.env):
        ...
        class agent(TeleopPipelineConfig.env.agent):
            class_name = "GalaxeaR1LiteRightArmAgent"
