...
class KukaIIWA14SingleArmBenchmarkPipelineConfig(BenchmarkPipelineConfig):
    """KUKA IIWA14 single-arm benchmark config"""
    ...
    class robot(BenchmarkPipelineConfig.robot):
        class cfg(BenchmarkPipelineConfig.robot.cfg):
            class_name = "KukaIIWA14SingleArmDynamic1Config"
    ...
    class env(BenchmarkPipelineConfig.env):
        ...
        class agent(BenchmarkPipelineConfig.env.agent):
            class_name = "KukaIIWA14SingleArmAgent"
