...
from spark_pipeline import R1LiteTeleopPipelineConfig as PipelineConfig
...
if __name__ == "__main__":
    ROBOT_CFG_LIST = [
        "R1LiteUpperDynamic1Config",
        "R1LiteUpperDynamic1CollisionConfig",
    ]

    AGENT_CFG_LIST = [
        "R1LiteMujocoFixedBaseAgent",
    ]
    
    run(robot_cfg = "R1LiteUpperDynamic1CollisionConfig",
        agent_cfg = "R1LiteMujocoFixedBaseAgent",
        safe_algo = "rssa",
        safety_index = "si1")
