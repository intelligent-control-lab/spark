...
from spark_pipeline import LRMate200iD3fTeleopPipelineConfig as PipelineConfig
...
if __name__ == "__main__":
    ROBOT_CFG_LIST = [
        "LRMate200iD3fSingleDynamic1Config",
        "LRMate200iD3fSingleDynamic1CollisionConfig",
    ]

    AGENT_CFG_LIST = [
        "LRMate200iD3fMujocoSingleAgent",
    ]
    
    run(robot_cfg = "LRMate200iD3fSingleDynamic1CollisionConfig",
        agent_cfg = "LRMate200iD3fMujocoSingleAgent",
        safe_algo = "rssa",
        safety_index = "si1")