...
from spark_pipeline import Gen32fTeleopPipelineConfig as PipelineConfig
...
if __name__ == "__main__":
    ROBOT_CFG_LIST = [
        "Gen3SingleDynamic1Config",
        "Gen3SingleDynamic1CollisionConfig"
    ]

    AGENT_CFG_LIST = [
        "Gen3MujocoFixedBaseAgent",
    ]
    
    run(robot_cfg = "Gen3SingleDynamic1CollisionConfig",
        agent_cfg = "Gen3MujocoFixedBaseAgent",
        safe_algo = "rssa",
        safety_index = "si1")