...
from spark_pipeline import Gen32fBenchmarkPipelineConfig as PipelineConfig
...
if __name__ == "__main__":
    ...
    TASK_CASE_LIST = [
        "Gen3Single_D1_AG_SO_v0",
        "Gen3Single_D2_AG_SO_v0",
    ]
    
    run(test_case_name = "Gen3Single_D2_AG_SO_v0",
        safe_algo = "rssa",
        safety_index = "si2")