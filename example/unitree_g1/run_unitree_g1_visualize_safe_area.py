...
def config_safety_module(cfg: PipelineConfig, **kwargs):
    ...
    match safe_algo:
        ...
        case "rssa":
            ...
            cfg.policy.safe_controller.safe_algo.eta_ssa = 1.0
            cfg.policy.safe_controller.safe_algo.control_weight = [
                1.0,
                1.0,
                1.0,  # waist
        ...
        case "sss":
            ...
            cfg.policy.safe_controller.safe_algo.lambda_sss = 1.0
        ...
        case "cbf":
            ...
            cfg.policy.safe_controller.safe_algo.lambda_cbf = 1.0
            cfg.policy.safe_controller.safe_algo.slack_weight = 1e3
            cfg.policy.safe_controller.safe_algo.control_weight = [
                1.0,
                1.0,
    ...
    if "FixedBase" in cfg.robot.cfg.class_name:
        cfg.policy.safe_controller.safe_algo.control_weight = (
            cfg.policy.safe_controller.safe_algo.control_weight[:-3]
        )
...
def config_pipeline(cfg: PipelineConfig, **kwargs):
    ...
    cfg.robot.cfg.class_name = kwargs.get("robot_cfg", "UnitreeG1FixedBaseDynamic2Config")
...
if __name__ == "__main__":
    save_path = "./log"
    run(
        robot_cfg="UnitreeG1FixedBaseDynamic2Config",
        safe_algo="rssa",
        safety_index="si2",
        save_path=save_path,
    )
