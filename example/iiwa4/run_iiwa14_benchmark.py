...
from spark_pipeline import IIWA142fBenchmarkPipelineConfig as PipelineConfig
...
if __name__ == "__main__":
    ...
    TASK_CASE_LIST = [
        "IIWA14Single_D1_AG_SO_v0",  
        "IIWA14Single_D2_AG_SO_v0", 
    ]
    
    run(test_case_name = "IIWA14Single_D2_AG_SO_v0",
        safe_algo = "rssa",
        safety_index = "si2")